...
% Loop through both modes: 1 = Training Set, 2 = Test Set
for Generation_Mode = [1, 2]

    if Generation_Mode == 1
        % 训练集：基准网格
        Path_root_Results = "Ideal Power Grid_Train"; 
        ...
        Path_root_Results = "Ideal Power Grid_Test";
        
        P_range = linspace(-1 + 0.018, -0.3 - 0.018, 11); % 位于原网格间隙
        Q_range = linspace(-1 + 0.05, 1 - 0.05, 11);
        V_range = 1; 
        xi_range = linspace(-pi/18 + 0.02, pi/12 - 0.08, 11);
